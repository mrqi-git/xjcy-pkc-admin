...
module.exports = merge(webpackBaseConfig, {
    ...
    plugins: [
        ...
        new CopyWebpackPlugin([
            ...
            {
                from: 'src/views/component-group/main-components/theme-switch/theme'
            },
            {
                from: 'src/views/component-group/my-components/text-editor/tinymce'
            }
        ], {
            ignore: [
                'text-editor.vue'
        ...
        new HtmlWebpackPlugin({
            title: 'xjcy-pkc-admin v' + package.version,
            favicon: './td_icon.ico',
            filename: '../index.html',
