...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_message_vue__ = __webpack_require__(524);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__babel_loader_node_modules_vue_loader_lib_template_compiler_index_id_data_v_5792e681_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_message_vue__ = __webpack_require__(950);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__babel_loader_node_modules_vue_loader_lib_template_compiler_index_id_data_v_5792e681_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_message_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__babel_loader_node_modules_vue_loader_lib_template_compiler_index_id_data_v_5792e681_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_message_vue__);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__babel_loader_node_modules_vue_loader_lib_template_compiler_index_id_data_v_5792e681_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_message_vue___default.a,
...
var update = __webpack_require__(18)("363a41d3", content, false);
...
var render = function render() {
  ...
  return _c("div", { staticClass: "message-main-con" }, [_c("div", { staticClass: "message-mainlist-con" }, [_c("div", [_c("Button", {
  ...
  }, [_c("transition", { attrs: { name: "mes-current-type-btn" } }, [_c("Icon", {
    directives: [{
      name: "show",
      rawName: "v-show",
  ...
  })], 1), _c("span", { staticClass: "mes-type-btn-text" }, [_vm._v("未读消息")]), _c("Badge", {
    ...
    attrs: { type: "checkmark" }
  })], 1), _c("span", { staticClass: "mes-type-btn-text" }, [_vm._v("已读消息")]), _c("Badge", {
    staticClass: "message-count-badge-outer",
    attrs: {
      "class-name": "message-count-badge",
    ...
    attrs: { type: "checkmark" }
  })], 1), _c("span", { staticClass: "mes-type-btn-text" }, [_vm._v("回收站")]), _c("Badge", {
    staticClass: "message-count-badge-outer",
    attrs: {
      "class-name": "message-count-badge",
      count: _vm.recyclebinCount
    }
  })], 1)], 1)]), _vm._v(" "), _c("div", { staticClass: "message-content-con" }, [_c("transition", { attrs: { name: "view-message" } }, [_vm.showMesTitleList ? _c("div", { staticClass: "message-title-list-con" }, [_c("Table", {
    ref: "messageList",
    attrs: {
  ...
  })], 1) : _vm._e()]), _vm._v(" "), _c("transition", { attrs: { name: "back-message-list" } }, [!_vm.showMesTitleList ? _c("div", { staticClass: "message-view-content-con" }, [_c("div", { staticClass: "message-content-top-bar" }, [_c("span", { staticClass: "mes-back-btn-con" }, [_c("Button", {
    attrs: { type: "text" },
    on: { click: _vm.backMesTitleList }
  }, [_c("Icon", { attrs: { type: "chevron-left" } }), _vm._v("  返回")], 1)], 1), _vm._v(" "), _c("h3", { staticClass: "mes-title" }, [_vm._v(_vm._s(_vm.mes.title))])]), _vm._v(" "), _c("p", { staticClass: "mes-time-con" }, [_c("Icon", { attrs: { type: "android-time" } }), _vm._v("  " + _vm._s(_vm.mes.time))], 1), _vm._v(" "), _c("div", { staticClass: "message-content-body" }, [_c("p", { staticClass: "message-content" }, [_vm._v(_vm._s(_vm.mes.content))])])]) : _vm._e()])], 1)]);
};
var staticRenderFns = [];
